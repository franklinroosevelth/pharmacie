          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">Liste des produits enregistrées</h1>
	...
	<script>
		...
		$(document).ready(function()
		{
			function afficher_liste_vente()
			{
				...
				$.post('../controlers/afficher_entite.php?nom_entite=article',{article_designation:recherche},function(donnee){
					$('.tbody_article').html(donnee);
				});
