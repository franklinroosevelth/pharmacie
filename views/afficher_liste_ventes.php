...
<body>
          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">Liste des ventes enregistrées</h1>
					...
					<div class="col-12 col-lg-6" style="min-width:100%;">
							<div class="card" style="min-width:100%;">
								...
								<form method="post" action="../controlers/enregistrer_article_achat.php">
									<div class="card-body">
										<input type="text" class="form-control input_recherche input_txt article_designation" placeholder="Rechercher en saisissant le code ou la date de la vente" required>
									</div>
								</form>
							</div>
								...
								<table class="table table-hover my-0">
									<thead>
										<tr>
											...
											<th class="d-none d-md-table-cell">Montant total</th>
											<th class="d-none d-md-table-cell">En franc</th>
											<th class="d-none d-md-table-cell">Date et heure de la vente</th>
	...
	<script>
		...
		$(document).ready(function()
		{
			...
			{
				var code_vente = $('.input_recherche').val();
				$.post('../controlers/afficher_entite.php?nom_entite=article_vente',{code_vente:code_vente},function(donnee){
