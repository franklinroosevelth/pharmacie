					...
					<div class="row">
						<div class="col-12 col-lg-6" style="min-width:100%;">
							<div class="card">
									...
									<div class="card-body">
										<br>
									<center><h1 class="h3 d-inline align-middle">Voulez-vous vraiment supprimer cet achat ?
									<br>
									</h1></center>
										<br>
										...
										<br>
										<form method="post" action="../controlers/supprimer_entite.php?nom_entite=article_achat&id_entite=<?php echo $_GET['id_entite'];?> ">
